...
const FRAME_AUDIO_UP   = 0x11; // ESP32 → Server: microphone audio
const FRAME_IMAGE_UP   = 0x12; // ESP32 → Server: camera image
const FRAME_AUDIO_DOWN = 0x21; // Server → ESP32: TTS audio
...
module.exports = { FRAME_AUDIO_UP, FRAME_IMAGE_UP, FRAME_AUDIO_DOWN, parseFrame, buildFrame };
